...
plangular.directive('plangular', ['$timeout', 'plangularConfig', '$sce', function($timeout, plangularConfig, $sce) {
  ...
  return {
    ...
    link: function(scope, elem, attr) {
      ...
      var src = 'https://soundcloud.com/hopsin/tracks';
      scope.player = player;
      ...
      function createSrc(track) {
        if (track.stream_url) {
          ...
          track.src = $sce.trustAsResourceUrl(track.stream_url + sep + 'client_id=' + client_id);
        }
        return track;
      }
